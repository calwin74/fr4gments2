...
function mainImpl()
{
    ...
    //console.log("start camera at ", camera_start_x, camera_start_y);
	...
	//drag left
        if (load.left)
        {
	    //floor rounds to nearest lowest int. Negative number.
            //var tile_diff = -Math.floor((-diff_x)/HEX_HORIZONTAL);
            //console.log("tile diff", tile_diff, diff_x);
            //world_stats.x_coord = world_stats.x_coord - tile_diff;
	...
	//drag bottom
        if (load.bottom)
        {
            //var tile_diff = Math.floor(diff_y/HEX_VERTICAL);
            //console.log("tile diff", tile_diff, diff_y);
            //world_stats.y_coord = world_stats.y_coord - tile_diff;
...
function getSelectedHexagon(px, py, current_x, current_y)
{
    ...
    //console.log("first col row", column, row);
    ...
    //console.log("relColumn:", relColumn);
    //console.log("relRow:", relRow);
    ...
    //console.log("second col row", column, row);
...
function dragStart(event, ui)
{
    ...
    //console.log("start", event.pageX, y_start);
    ...
    //console.log("position:", start_position.left, start_position.top);
}
...
function getServerAddress() {
    //site specifics ...
    var address = "http://localhost:8079";
    return address;
}
